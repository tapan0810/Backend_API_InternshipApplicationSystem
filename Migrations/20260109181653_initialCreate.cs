        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationDeadline = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserRole = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    SecretKey = table.Column<string>(type: "nvarchar(56)", maxLength: 56, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FeedbackId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    FeedbackText = table.Column<string>(type: "nvarchar(1012)", maxLength: 1012, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    InternshipId = table.Column<int>(type: "int", nullable: false),
                    UniversityName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    DegreeProgram = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    Resume = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LinkedInProfile = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    ApplicationStatus = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    ApplicationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternshipApplications", x => x.InternshipApplicationId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "Idx_InternshipApplication_DegreeProgram",
                table: "InternshipApplications",
                column: "DegreeProgram");
            ...
            migrationBuilder.CreateIndex(
                name: "Idx_Internship_CompanyName",
                table: "Internships",
                column: "CompanyName");

            migrationBuilder.CreateIndex(
                name: "Idx_Internship_Location",
                table: "Internships",
                column: "Location");
        }
